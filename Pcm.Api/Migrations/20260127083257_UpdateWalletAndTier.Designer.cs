...
namespace Pcm.Api.Migrations
{
    ...
    [Migration("20260127083257_UpdateWalletAndTier")]
    partial class UpdateWalletAndTier
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pcm.Api.Entities.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "admin-id-123",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e0d14c37-a725-430e-86d5-1715c2175ac5",
                            Email = "admin@pcm.com",
                            EmailConfirmed = true,
                            FullName = "Administrator",
                            JoinDate = new DateTime(2026, 1, 27, 15, 32, 55, 701, DateTimeKind.Local).AddTicks(9894),
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@PCM.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAELHIaBVNu3azFGVgkE6i5Jl+Db8gKbaSsXiktYikUbcYCmyKFfitg9cp+RDWduLNxg==",
                            PhoneNumberConfirmed = false,
                            RankLevel = 3.0,
                            SecurityStamp = "5db7f389-787b-47c4-91c8-502615732fde",
                            Tier = "Bronze",
                            TotalDeposited = 0m,
                            TotalSpent = 0m,
                        ...
                        new
                        {
                            Id = "member-id-456",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a3be3c87-95cc-4135-8372-2ebdc296bc0f",
                            Email = "user1@pcm.com",
                            EmailConfirmed = true,
                            FullName = "Nguyễn Văn A",
                            JoinDate = new DateTime(2026, 1, 27, 15, 32, 55, 764, DateTimeKind.Local).AddTicks(1918),
                            LockoutEnabled = false,
                            NormalizedEmail = "USER1@PCM.COM",
                            NormalizedUserName = "USER1",
                            PasswordHash = "AQAAAAIAAYagAAAAEB3FYXujn4zWRO+b9jvJNzDz1qKd5N1zbrZnhZo+dayfSngZls7emm4nEk2GrD9tVA==",
                            PhoneNumberConfirmed = false,
                            RankLevel = 3.0,
                            SecurityStamp = "a3bcc7fd-309b-437d-b7df-ff24ce4064ec",
                            Tier = "Bronze",
                            TotalDeposited = 0m,
                            TotalSpent = 0m,
                            TwoFactorEnabled = false,
